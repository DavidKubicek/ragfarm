...
CHAPTERS=(
  ...
  "3  Deployment guide|docs/deployment.md"
  "4  Prompt library|docs/prompts.md"
  "5  Ingestion pipeline|docs/ingestion-pipeline.md"
  "6a Embedder README|infra/embedder/README.md"
  "6b llama.cpp README|infra/llama/README.md"
  "7  Configuration reference (.env.example)|.env.example"
  "8a Model record — LLM|models/llm/MODEL.md"
  "8b Model record — embedder|models/embeddings/MODEL.md"
  "8c Model record — reranker|models/reranker/MODEL.md"
  "9a Instrumentation — README|tests/tracing/README_INSTRUMENTATION.md"
  "9b Instrumentation — full guide|tests/tracing/INSTRUMENTATION_GUIDE.md"
  "9c Tracer integration guide|tests/tracing/TRACER_INTEGRATION_GUIDE.md"
  "9d RAG pipeline setup notes|tests/tracing/RAG_PIPELINE_SETUP.md"
  "9e Quick reference — instrumentation|tests/tracing/QUICK_REFERENCE.md"
  "9f Quick reference — context diagnosis|tests/tracing/QUICK_REFERENCE_CONTEXT_DIAGNOSIS.md"
  "9g Context blowup diagnosis guide|tests/tracing/CONTEXT_DIAGNOSIS_GUIDE.md"
  "10 Build progress (PROGRESS.md)|PROGRESS.md"
)
