...
VISION_GROUNDING_SYSTEM = (
    ...
    "cropped, or you are uncertain, say so instead of guessing. For OCR / receipt / form tasks, "
    "output the fields exactly as printed, keeping the original punctuation and number formatting.\n\n"
